...
export function getProjectBanner(selectedAccount: Account | null | undefined) {
    return `<p id="project-banner-gap"></p>
        <div id="project-banner" style="display: block; background-color: #EBF83E; width: fit-content; border-radius: 4px; color: #0A101D; font-weight: 500; line-height: 1; padding: 5px 10px">
