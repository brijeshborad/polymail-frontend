...
export const HEADER_NOT_ALLOWED_PATHS = ['/onboarding', '/onboarding/login', '/onboarding/signup', '/onboarding/connect-account', '/onboarding/complete-profile'];
...
export const ACTIVITY_FEED_EVENT_TYPES = ['ThreadShared', 'ProjectCreated', 'ProjectInvite'];
