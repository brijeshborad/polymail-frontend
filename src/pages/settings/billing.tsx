                    ...
                    <Flex direction={"column"} gap={10} className={styles.settingBilling}>
                        <div className={styles.settingBillPlan}>
                            <div className={styles.settingBillingPlan}>
                                <Flex alignItems={'center'} justify={'space-between'} pb={4} mb={4}
                            ...
                            <Button height={'auto'} padding={'0'} className={styles.changePlan} variant='ghost'>Change
                                Plan</Button>
                        </div>
                        ...
                        <div className={styles.paymentMethod}>
                            ...
                            <Button height={'auto'} padding={'0'} mt={2} fontSize={'14px'}
                                    className={styles.addPaymentMethod} variant='ghost' onClick={onOpen}>+ Add Payment
                                Method</Button>
                        </div>
                    </Flex>
                            ...
                            <ModalBody padding={'8px 40px 16px'}>
                                <Flex direction={'column'} gap={4}>
                                    <div className={styles.newPaymentInput}>
                                        <Text mb='8px' fontSize={'13px'} fontWeight={500} color={'#000000'}>Name on
                                            card</Text>
                                        <Input placeholder='Card Holder Name' size='sm'/>
                                    </div>
                                    <div className={styles.newPaymentInput}>
                                        <Text mb='8px' fontSize={'13px'} fontWeight={500} color={'#000000'}>Card
                                            number</Text>
                                    ...
                                    <Grid templateColumns='repeat(2, 1fr)' gap={6}>
                                        ...
                                        <GridItem w='100%'>
                                            <div className={styles.newPaymentInput}>
                                                <Text mb='8px' fontSize={'13px'} fontWeight={500}
                                                      color={'#000000'}>CVV</Text>
                                                <Input placeholder='123' size='sm'/>
                                            </div>
                                        </GridItem>
                                    </Grid>
                                    <div className={styles.newPaymentInput}>
                                        <Text mb='8px' fontSize={'13px'} fontWeight={500} color={'#000000'}>ZIP
                                            code</Text>
